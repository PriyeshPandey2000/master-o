...
const App = () => {
    ...
    useEffect(() => {
        const fetchPoints = async () => {
            const result = await axios.get('https://master-o-ou.vercel.app/api/game/points');
    ...
    const handleRollDice = async () => {
        const result = await axios.post('https://master-o-ou.vercel.app/api/game/roll', { betAmount, betType });
